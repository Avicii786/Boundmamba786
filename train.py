...
def parse_args():
    ...
    parser.add_argument('--batch_size', type=int, default=8) # Default increased to 8 for 2x GPUs
...
def train(args):
    ...
    # =================================================================
    # [NEW] MULTI-GPU SUPPORT (DataParallel)
    # =================================================================
    ...
    for epoch in range(args.epochs):
        ...
        # =================================================================
        # [NEW] MULTI-GPU SAFE CHECKPOINT SAVING
        # DataParallel wraps the model in a `.module` attribute. We must 
        # save `model.module.state_dict()` so we can easily load it later 
        # on a single GPU if needed.
        # =================================================================
        ...
        torch.save(model_to_save.state_dict(), os.path.join(args.save_dir, f'boundnext_{args.model_type}_last.pth'))
